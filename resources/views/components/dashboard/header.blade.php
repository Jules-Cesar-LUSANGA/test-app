  ...
  >
    <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
      ...
      <a class="block flex-shrink-0 lg:hidden" href="#">
        <img src="{{ asset('assets/logo.svg') }}" class="h-10 rounded-full" alt="Logo" />
      </a>
    </div>
      ...
      <div
        ...
        >
          ...
          <span class="h-12 w-12 rounded-full">
            <img src="{{ asset('assets/avatar.png') }}" alt="User" />
          </span>
        ...
        >
          <ul
            class="border-b border-stroke px-6 py-4 dark:border-strokedark"
          >
            <li>
              <a
